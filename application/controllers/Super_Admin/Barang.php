...
class Barang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('super_admin/barang', $data);
    }
    ...
    public function add()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->session->set_flashdata('error', 'Gagal menambahkan Barang. Pastikan data sudah benar.');
            ...
            if ($this->Model_Barang->insert($data)) {
