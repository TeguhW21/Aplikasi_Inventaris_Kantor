                                ...
                                <div class="modal fade" id="modalTambah" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= site_url('Super_Admin/Barang/add') ?>" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item" href="<?= base_url('Super_Admin/Alokasi/action/' . $br['id']) ?>"><i class="ri-pencil-line me-1"></i> Alokasi</a>
                                                                        <a class="dropdown-item" href="<?= base_url('Super_Admin/History/alokasi/' . $br['id']) ?>"><i class="ri-pencil-line me-1"></i> History Alokasi</a>
                                                                        <a class="dropdown-item" onclick="confirmDelete('<?= site_url('Super_Admin/Barang/delete/' . $br['id']); ?>')"><i class="ri-delete-bin-6-line me-1"></i> Delete</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <div class="modal fade" id="modalEdit-<?= $br['id'] ?>" tabindex="-1" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <form action="<?= site_url('Super_Admin/Barang/update/' . $br['id']) ?>" method="post" enctype="multipart/form-data">
                                                                        <div class="modal-body">
                                                                            <div class="row">
